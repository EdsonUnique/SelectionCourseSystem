...
<html>
	...
	<body>
		...
		<div class="display_select">
			...
			<s:if test="%{#session.pb.pageData.size()==0}"><span style="color:red;">暂无所选课程</span></s:if>
			<s:else>
			<table cellpadding="10px" cellspacing="2px" border="1px solid" style="text-align: center;">
				...
				<form action="${pageContext.request.contextPath }/stu_deleteSelection" method="post" onsubmit="return deleteSelectionConfirm();">
				<tr>
					<td>
					...
					<td>
						<button type="submit" ${is_start==0?'disabled':'' }>删除</button>
					</td>
				</tr>
				</form>
				</s:iterator>
